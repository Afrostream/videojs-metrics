...
},{"global/window":3,"is-function":8,"once":9,"parse-headers":12,"xtend":13}],8:[function(require,module,exports){
...
},{"is-function":8}],11:[function(require,module,exports){
...
},{"for-each":10,"trim":11}],13:[function(require,module,exports){
module.exports = extend
	...
	_createClass(Metrics, [{
		...
		value: function notify(evt) {
			...
			try {
				...
				Metrics.xhr(this.options(), pickedData, function (err, resp, body) {
					if (err) {
						throw new Error(err);
					}
				});
...
},{"./utils.js":16,"global/document":2,"global/window":3,"xhr":7}],15:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./metrics":14}],16:[function(require,module,exports){
'use strict';
...
},{"global/document":2,"global/window":3}],17:[function(require,module,exports){
(function (global){
'use strict';
...
var _srcMetrics = require('../src/metrics');

var _srcMetrics2 = _interopRequireDefault(_srcMetrics);

var _playerProxy = require('./player-proxy');

var _playerProxy2 = _interopRequireDefault(_playerProxy);

_qunit2['default'].module('metrics', {
...
_qunit2['default'].test('metricsMaker takes a player and returns a metrics', function (assert) {
	var metrics = (0, _srcMetrics2['default'])((0, _playerProxy2['default'])(), {});
...
_qunit2['default'].test('triger metrics', function (assert) {
	...
	var metrics = (0, _srcMetrics2['default'])(player, {});
...
},{"../src/metrics":14,"./player-proxy":18,"global/window":3}],18:[function(require,module,exports){
(function (global){
'use strict';
...
},{"node.extend":4}],19:[function(require,module,exports){
(function (global){
'use strict';
...
_qunit2['default'].test('registers itself with video.js', function (assert) {
  assert.expect(1);
  assert.strictEqual(_videoJs2['default'].getComponent('Player').prototype.playlist, _srcPlugin2['default'], 'videojs-metrics plugin was registered');
});
